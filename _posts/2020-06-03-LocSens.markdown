...
layout: post
comments: true
title:  "LocSens: Location Sensitive Image Retrieval and Tagging"
...
<span style="color:brown">**This work has been published in ECCV 2020. Refer to the [paper](https://arxiv.org/) to access the full and formal article. Here I explain informally and briefly the experiments conducted and the conclusions obtained.**</span>
...
We have *25M images with an average of 4.25 hashtags*. The tags are noisy and highly unbalanced. We benchmark different training strategies to learn images and tags representations, in what we call a *learning with hashtag supervision* task. Here I briefly mention the setups tried and the results, but I strongly recommend you to *read the [paper](https://arxiv.org/) if you are interested in this comparison*.
 ...
 <div class="imgcap">
	<img src="/assets/LocSens/retrieval_agnostic.png" width="100">
	<div class="thecap">
...
<div class="imgcap">
	<img src="/assets/LocSens/variance_plot.png" width="300">
	<div class="thecap">
...
<div class="imgcap">
	<img src="/assets/LocSens/retrieval_results.png" width="700">
	<div class="thecap">
...
<div class="imgcap">
	<img src="/assets/LocSens/failures_retrieval.png" width="700">
	<div class="thecap">
	Query hashtags with different query locations and top 3 retrieved images. 
	</div>
</div>
...
<div class="imgcap">
	<img src="/assets/LocSens/tagging_table.png" width="600">
	<div class="thecap">
...
<div class="imgcap">
	<img src="/assets/LocSens/tagging_results.png" width="700">
	<div class="thecap">
...
<div class="imgcap">
	<img src="/assets/LocSens/tagging_results_multiple.png" width="700">
	<div class="thecap">
...
## Future Work
 ...
 Read the ECCV2020 [paper](https://arxiv.org/) for more details about this work.
