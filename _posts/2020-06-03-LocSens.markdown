...
<div class="imgcap">
	<img src="/assets/LocSens/bridges.png" width="800">
	<div class="thecap">
	Top retrieved image by LocSens for the query hashtag bridge at different locations.	</div>
</div>

<div class="imgcap">
	<img src="/assets/LocSens/temple.png" width="800">
	<div class="thecap">
...
We have *25M images with an average of 4.25 hashtags*. The tags are noisy and highly unbalanced. We benchmark different training strategies to learn images and tags representations, in what we call a *learning with hashtag supervision* task. Here I briefly mention the setups tried and the results, but I strongly recommend you to *read the [paper](https://arxiv.org/) if you are interested in this comparison*.
 ...
 <div class="imgcap">
	<img src="/assets/LocSens/retrieval_agnostic.png" width="300">
	<div class="thecap">
...
<div class="imgcap">
	<img src="/assets/LocSens/retrieval_results.png" width="800">
	<div class="thecap">
...
<div class="imgcap">
	<img src="/assets/LocSens/failures_retrieval.png" width="800">
	<div class="thecap">
	Query hashtags with different query locations and top 3 retrieved images. 
	</div>
</div>
...
<div class="imgcap">
	<img src="/assets/LocSens/tagging_results.png" width="800">
	<div class="thecap">
...
<div class="imgcap">
	<img src="/assets/LocSens/tagging_results_multiple.png" width="800">
	<div class="thecap">
