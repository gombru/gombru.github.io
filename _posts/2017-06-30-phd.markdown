...
excerpt: "Learning of a joint embedding of text and images using InstaCities1M. An LDA and a CNN are used to embbed text and images respectibly in a topic space. Then a retrieval by text system is built and tested."
...
**"snow"**. However we get some errors in simple queries. We get some squirrels when querying "snow". Nevertheless they have evolved for years to be able to camuflate there.
