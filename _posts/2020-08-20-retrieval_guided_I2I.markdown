...
In this paper **we propose a method that improves GMM-UNIT performance by exploiting an image retrieval system to provide during training real images similar to the input one but with the desired output attributes**. The hypothesis is that GMM-UNIT can benefit from those real retrieved images to generate more realistic images.

<div class="imgcap">
<img src="/assets/retrieval_guided_I2I/I2I_results_comparison.png" width="750">
<div class="thecap">
Results of the original GMM-Unit model and its improvement (RG-UNIT).</div>
</div>
...
To create the triplets to train our model, we exploit the I2I translation system trained in step 1, as explained in the following figure:

<div class="imgcap">
<img src="/assets/retrieval_guided_I2I/triplets.png" width="600">
</div>

- **Anchor**: The content features of a given image and the desired target attributes.
- **Positive**: The anchor image is translated to the desired attributes. The positive sample is the content features and the attributes features of the generated image.
...
<div class="imgcap">
<img src="/assets/retrieval_guided_I2I/retrieval_quantitative_results.png" width="300">
</div>

Here some results of the trained retrieval system:

<div class="imgcap">
<img src="/assets/retrieval_guided_I2I/retrieval_results.png" width="600">
</div>
...
<div class="imgcap">
<img src="/assets/retrieval_guided_I2I/full_pipeline.png" width="600">
</div>
...
<div class="imgcap">
<img src="/assets/retrieval_guided_I2I/I2I_quantitative_results.png" width="300">
</div>
...
<div class="imgcap">
<img src="/assets/retrieval_guided_I2I/I2_quantitative_results_2.png" width="300">
</div>
